...
public class DatabaseConnection
{
    ...
    public void add(Show show){
        ...
        /*try{
            ...
            //System.out.println("Creating statement...");
            //stmt = conn.createStatement();
            /*sql =   "INSERT INTO `show` (title, runtime, poster_path) VALUES (" + title + ", " + runTime + ", " + image + ");" +
                    "SET @show_id = LAST_INSERT_ID();" +
                    "INSERT INTO `show_genre` (id_genre, id_show) VALUES (" + genre +");" +
                    "INSERT INTO `show_actor` (id_actor, id_show) VALUES (3, @show_id);" +
                    "INSERT INTO `show_actor` (id_actor, id_show) VALUES (4, @show_id);" +
                    "INSERT INTO `show_rating` (id_rating, id_show) VALUES (5, @show_id);";
